...
public class DelicateSipBlocks {
	...
	public static final BlockHeap ROUND_WINDOWS_BOTTOM_LEFT = BlockHeap.create(DelicateSip.createId("round_windows_bottom_left"), RoundWindowBlock::new, FabricBlockSettings.copyOf(Blocks.OAK_WOOD).nonOpaque().allowsSpawning(Blocks::never).solidBlock(Blocks::never).suffocates(Blocks::never).blockVision(Blocks::never), DelicateSip.fromWood("round_window_bottom_left")).withItem(new FabricItemSettings());
	public static final BlockHeap ROUND_WINDOWS_BOTTOM_RIGHT = BlockHeap.create(DelicateSip.createId("round_windows_bottom_right"), RoundWindowBlock::new, FabricBlockSettings.copyOf(Blocks.OAK_WOOD).nonOpaque().allowsSpawning(Blocks::never).solidBlock(Blocks::never).suffocates(Blocks::never).blockVision(Blocks::never), DelicateSip.fromWood("round_window_bottom_right")).withItem(new FabricItemSettings());
	public static final BlockHeap ROUND_WINDOWS_TOP_LEFT = BlockHeap.create(DelicateSip.createId("round_windows_top_left"), RoundWindowBlock::new, FabricBlockSettings.copyOf(Blocks.OAK_WOOD).nonOpaque().allowsSpawning(Blocks::never).solidBlock(Blocks::never).suffocates(Blocks::never).blockVision(Blocks::never), DelicateSip.fromWood("round_window_top_left")).withItem(new FabricItemSettings());
	public static final BlockHeap ROUND_WINDOWS_TOP_RIGHT = BlockHeap.create(DelicateSip.createId("round_windows_top_right"), RoundWindowBlock::new, FabricBlockSettings.copyOf(Blocks.OAK_WOOD).nonOpaque().allowsSpawning(Blocks::never).solidBlock(Blocks::never).suffocates(Blocks::never).blockVision(Blocks::never), DelicateSip.fromWood("round_window_top_right")).withItem(new FabricItemSettings());
	public static final BlockHeap ROUND_WINDOW_PANES_BOTTOM_LEFT = BlockHeap.create(DelicateSip.createId("round_window_panes_bottom_left"), PaneBlock::new, FabricBlockSettings.copyOf(Blocks.OAK_WOOD).nonOpaque().allowsSpawning(Blocks::never).solidBlock(Blocks::never).suffocates(Blocks::never).blockVision(Blocks::never), DelicateSip.fromWood("round_window_pane_bottom_left")).withItem(new FabricItemSettings());
	public static final BlockHeap ROUND_WINDOW_PANES_BOTTOM_RIGHT = BlockHeap.create(DelicateSip.createId("round_window_panes_bottom_right"), PaneBlock::new, FabricBlockSettings.copyOf(Blocks.OAK_WOOD).nonOpaque().allowsSpawning(Blocks::never).solidBlock(Blocks::never).suffocates(Blocks::never).blockVision(Blocks::never), DelicateSip.fromWood("round_window_pane_bottom_right")).withItem(new FabricItemSettings());
	public static final BlockHeap ROUND_WINDOW_PANES_TOP_LEFT = BlockHeap.create(DelicateSip.createId("round_window_panes_top_left"), PaneBlock::new, FabricBlockSettings.copyOf(Blocks.OAK_WOOD).nonOpaque().allowsSpawning(Blocks::never).solidBlock(Blocks::never).suffocates(Blocks::never).blockVision(Blocks::never), DelicateSip.fromWood("round_window_pane_top_left")).withItem(new FabricItemSettings());
	public static final BlockHeap ROUND_WINDOW_PANES_TOP_RIGHT = BlockHeap.create(DelicateSip.createId("round_window_panes_top_right"), PaneBlock::new, FabricBlockSettings.copyOf(Blocks.OAK_WOOD).nonOpaque().allowsSpawning(Blocks::never).solidBlock(Blocks::never).suffocates(Blocks::never).blockVision(Blocks::never), DelicateSip.fromWood("round_window_pane_top_right")).withItem(new FabricItemSettings());
	...
	public static void register(AdvancedContainer mod) {
		...
		ROUND_WINDOW_PANES_BOTTOM_LEFT.register(mod::createId);
		ROUND_WINDOW_PANES_BOTTOM_RIGHT.register(mod::createId);
		ROUND_WINDOW_PANES_TOP_LEFT.register(mod::createId);
		ROUND_WINDOW_PANES_TOP_RIGHT.register(mod::createId);
